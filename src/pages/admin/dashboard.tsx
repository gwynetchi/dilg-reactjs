...
const Dashboard = () => {
  ...
  const addTask = async () => {
    if (newTask.trim() && currentUser?.uid) {
      ...
      try {
        ...
        setTasks((prev) => [...prev, { id: docRef.id, ...newTaskObj }]);
        setNewTask("");
  ...
  const toggleTaskCompletion = async (id: string, completed: boolean) => {
    try {
      ...
      setStatusMessage(completed ? "Marked as incomplete" : "Task completed");
      setTimeout(() => setStatusMessage(null), 3000);
    } catch (err) {
          ...
          <div className="head-title">
            <div className="left">
              ...
              <ul className="breadcrumb">
                <li>
                  <a href="/dashboards" className="active">
                    Home
                  </a>
                </li>
                <li>
            ...
            <div className="metrics-panel">
              {[
                { label: "Total Reports Submitted", value: totalReports },
                {
                  ...
                  value: onTimeReports,
                  percent: onTimeReports / totalReports,
                },
                {
                  label: "Pending Reports",
                  value: pendingReports,
                  percent: pendingReports / totalReports,
                },
                {
                  label: "No Submission",
                  value: noSubmission,
                  percent: noSubmission / totalReports,
                },
                {
                  label: "Late Reports",
                  value: lateReports,
                  percent: lateReports / totalReports,
                },
                {
                  label: "For Revision",
                  value: forRevision,
                  percent: forRevision / totalReports,
                },
                {
                  label: "Incomplete Reports",
                  value: incomplete,
                  percent: incomplete / totalReports,
                },
