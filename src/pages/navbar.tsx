...
const MENU_ITEMS = {
  ...
  Admin: [
    ...
    { name: "Deleted One Shot Reports", icon: "bxs-message-alt-minus", path: "/admin/Deletedone_shot_reports" },
    ...
    { name: "Deleted Users", icon: "bx-user-x", path: "/admin/DeletedUsers" },
    ...
    { name: "Mayor Management", icon: "bxs-user-badge", path: "/admin/MayorManagement" },
  ],
};
